...
const Layout = () => {
  ...
  return (
    <>
        <div className='flex flex-row gap-2 bg-sky-500 text-white font-semibold p-3 justify-end w-full'>
            <ButtonAction color="black-outline" action={handleOpenConfirmation}>
        ...
        <div className='p-10'>
            ...
            >
              ...
              <DialogContent>
                <DialogContentText>
                  Are you sure you want to <span className='text-red-700'>delete all items </span> 
